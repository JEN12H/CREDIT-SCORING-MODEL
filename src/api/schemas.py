...
class PredictionRequest(BaseModel):
    ...
    customer_id: str = Field(..., description="The unique string ID of the customer (from user table)")
...
class CustomerCreate(BaseModel):
    """Credit profile fields to update for an existing user."""
    customer_id:        Optional[str] = Field(None, description="The user's string ID from the auth system.")
